...
import { LucideTriangleAlert, LucidePlus, LucideUsers, LucideX } from '@lucide/angular';
...
@Component({
  ...
  imports: [EmployeesTableComponent, EmployeeFormComponent, LucideUsers, LucidePlus, LucideX, LucideTriangleAlert],
